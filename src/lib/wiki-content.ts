...
export const WIKI_STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "credits.howP1b":
      " table. The Settings page sums the current month and shows a progress bar towards the 10-credit cap. Non-AI features (adding expenses manually, viewing charts, notifications, sync) do ",
    ...
    "credits.footnote":
      "When the 10-credit cap is reached, AI features pause until the next month; everything else keeps working normally.",
