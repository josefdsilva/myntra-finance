...
export const PERSONAS: PersonaDef[] = [
  ...
  {
    key: "pt-micro-business",
    email: `persona9@${SYNTHETIC_EMAIL_DOMAIN}`,
    label: "Oficina Silva, Lda (SME)",
    angle: "Four employees, lumpy invoices — the business-space angle.",
    displayName: "Oficina Silva (test persona)",
    householdName: "Oficina Silva (test)",
    kind: "business",
    country: "PT",
    currency: "EUR",
    adults: 1,
    ...
    sector: "auto",
    incomes: [
      { label: "Workshop services", monthly_amount: 14500, type: "services" },
      { label: "Parts resale", monthly_amount: 3200, type: "products" },
    ],
    debts: [
      {
        ...
        kind: "lease",
        monthly_amount: 480,
        principal_remaining: 18500,
        taeg_pct: 6.4,
        months_left: 40,
      },
    ],
    manualFixed: [
      { label: "Payroll", category: "payroll", monthly_amount: 7600 },
      { label: "Workshop rent", category: "rent", monthly_amount: 1450 },
      { label: "Utilities", category: "utilities", monthly_amount: 620 },
      { label: "Accountant", category: "professional_services", monthly_amount: 260 },
      { label: "Software & tools", category: "software", monthly_amount: 140 },
    ],
    manualVariable: [
      { label: "Parts & materials", category: "materials", monthly_amount: 3900 },
      { label: "Consumables", category: "supplies", monthly_amount: 540 },
      { label: "Marketing", category: "marketing", monthly_amount: 220 },
      { label: "Fees & charges", category: "fees", monthly_amount: 130 },
    ],
    spendBias: 1.06,
    historyMonths: 5,
