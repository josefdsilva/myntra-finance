  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <Button aria-label={t("plan.editTitle")}
                              size="icon"
                              variant="ghost"
                              className="size-7"
                              onClick={() => openEdit(p)}
      ...
      {resolved.length > 0 && (
        ...
        <Button aria-label={t("plan.reopen")}
                        variant="ghost"
                        size="icon"
                        onClick={() => reopen(p.id)}
                        title={t("plan.reopen")}
        ...
        <Button aria-label={t("common.delete")} variant="ghost" size="icon" onClick={() => remove(p.id)}>
