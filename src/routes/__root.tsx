...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Myntra: shared household budgeting with daily safe-to-spend, configurable allocation buckets, and AI expense capture." },
      { name: "author", content: "Myntra" },
      { property: "og:title", content: "Myntra — daily safe-to-spend & household allocations" },
      { property: "og:description", content: "Myntra: shared household budgeting with daily safe-to-spend, configurable allocation buckets, and AI expense capture." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Myntra — daily safe-to-spend & household allocations" },
      { name: "twitter:description", content: "Myntra: shared household budgeting with daily safe-to-spend, configurable allocation buckets, and AI expense capture." },
